...
*Figure: Simulation state at step = 10000 . **(Left)** Mid-plane slice of the longitudinal electric field Ex showing charge separation. **(Center)** Mid-plane slice of the magnetic field Bz demonstrating field perturbation. **(Right)** 3D spatial distribution of electrons (blue) and ions (red).*
